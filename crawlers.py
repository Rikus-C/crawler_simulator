...
# https://www.takealot.com/osah-drypak-18l-backpack-orange/PLID56719248?colour_variant=Yellow
...
class lead_crawler:
    ...
    def move_forward(self, scene, dt):
        ...
        delta_x = delta_forward*math.cos(q)
        delta_y = delta_forward*math.sin(q)
